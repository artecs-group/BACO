...
public:
    ...
    dynamic_bitset(const dynamic_bitset& db);  
    dynamic_bitset& operator= (const dynamic_bitset& db);

    ~dynamic_bitset();
  
  //NANOX COMPILES PRE C++11, No default nor move constructors are allowed
